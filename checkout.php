  ...
  <div class="container">
    ...
    <main>
      ...
      <div class="py-5 text-center">
        <h1 class="business-name">ABC Bakery</h1>
        <h2>Checkout form</h2>
      </div>
      ...
      <div class="row g-3">
          ...
          <ul class="list-group mb-3">
            ...
            foreach($_SESSION['shopping_cart'] as $key => $product){
              ...
              <li class="list-group-item d-flex justify-content-between lh-sm linen-rows">
                ...
                <span class="text-muted price-tag"><?php echo number_format(($product['quantity']  * $product_row['p_price'])); ?> VNĐ</span>
              </li>
            ...
            <li class="list-group-item d-flex justify-content-between total-row">
              <span>Total (VNĐ)</span>
              <strong class="price-tag"><?php echo number_format($_SESSION['total_price']); ?>VNĐ</strong>
            </li>
          </ul>
        ...
        <form action=
          ...
          <div class="row g-3">
            ...
            <a href="404.html" class="w-100 btn btn-primary btn-lg button">Continue to checkout</a>
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
      <p class="mb-1">&copy; 2024 QTieee</p>
